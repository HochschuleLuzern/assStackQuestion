...
class stack_ast_container_silent implements cas_evaluatable {
    ...
    public function get_decimal_digits(bool $evaluated = false) {
        ...
        foreach ($string as $i => $c) {
            ...
            if (strtolower($c) == 'e') {
                if (($currentnummeaningfulldigits + $currentnumleadingzeros + $currentnumindefinitezeros) > 0) {
            ...
            if ($c == '0') {
                ...
                $currentnumindefinitezeros = 0;
            } else if ($currentnummeaningfulldigits + $currentnumleadingzeros + $currentnumindefinitezeros > 0) {
